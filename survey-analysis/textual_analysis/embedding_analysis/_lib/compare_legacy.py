...
SELF_PRE_POST_POOLED_THREE_PANEL_AXIS_FONTSIZE = 23
SELF_PRE_POST_POOLED_THREE_PANEL_TITLE_FONTSIZE = 20
SELF_PRE_POST_POOLED_THREE_PANEL_TICK_FONTSIZE = 24
SELF_PRE_POST_POOLED_THREE_PANEL_ANNOT_FONTSIZE = 19
...
def _annotate_shift_accuracy_ols_and_corr(
    ...
    *,
    ...
    ax.text(
        ...
        ha="left",
        va="top",
        fontsize=VIZ_BRACKET_FONTSIZE if fontsize is None else fontsize,
        color=color,
        fontweight="bold",
        linespacing=1.25,
    )
...
def _draw_shift_accuracy_scatter_panel(
    ...
    *,
    ...
    tick_fs = (
        DIVERSITY_PRED_YTICK_FONTSIZE if tick_fontsize is None else tick_fontsize
    )
    if panel_title:
        if left_align_title:
            ax.set_title("")
...
def _draw_pooled_mean_shift_bar_panel(
    ...
    *,
    ...
    title_fontsize: float | None = None,
    tick_fontsize: float | None = None,
    bracket_fontsize: float | None = None,
) -> float:
    ...
    bracket_fs = VIZ_BRACKET_FONTSIZE if bracket_fontsize is None else bracket_fontsize
    ax.set_title("")
    ax._pooled_panel_title = ax.text(
        0.0,
        1.02,
...
def build_pooled_three_panel_combined_tex(
    *,
    ...
    return "\n".join([
        ...
        r"\rule{0pt}{1.0em} \\",
        rf"{{\large\textbf{{{SELF_PRE_POST_POOLED_THREE_PANEL_TITLES[3]}}}}}\\[0.45em]",
...
def _plot_pooled_abc_panels_pdf(
    ...
    _draw_pooled_mean_shift_bar_panel(
        ...
        title_fontsize=SELF_PRE_POST_POOLED_THREE_PANEL_TITLE_FONTSIZE,
        tick_fontsize=SELF_PRE_POST_POOLED_THREE_PANEL_TICK_FONTSIZE,
        bracket_fontsize=22,
    )
    ...
    _draw_shift_accuracy_scatter_panel(
        ...
        title_fontsize=SELF_PRE_POST_POOLED_THREE_PANEL_TITLE_FONTSIZE,
        tick_fontsize=SELF_PRE_POST_POOLED_THREE_PANEL_TICK_FONTSIZE,
        annot_fontsize=SELF_PRE_POST_POOLED_THREE_PANEL_ANNOT_FONTSIZE,
